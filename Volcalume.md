...
The program is a compiled MATLAB executable for <a href="{{ site.baseurl }}/release/Volcalume.rar"><i class="fa Windows"></i>Windows</a>, which will install both the MATLAB runtime (if required) and the program itself. 
