...
<div class="col-12 col-sm-8">
  ...
  <p><span class="bold">Main collaborator:</span> Zack Spica <a href="https://scholar.google.be/citations?user=OO3GY2YAAAAJ&hl=en" target="_blank"><i class="fab fa-google"></i> Scholar</a></p>
</div>
</div>
<hr>
...
<div class="col-12 col-sm-8 section">
    ...
    <p><span class="bold">Product:</span> Have a look to our <a href="tomomex.html" class="btn btn-light"><i class="fa fa-info-circle"></i> Data product</a>
